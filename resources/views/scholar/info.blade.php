                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($disbursements as $disbursement)
                                                            ...
                                                            <tr class="{{ $count % 2 == 0 ? 'even' : 'odd' }}">
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('scholar.disbursementEdit_info',$disbursement->id) }}" class="btn btn-primary btn-sm">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <form action="{{ route('scholar.disbursementdelete', $disbursement->id) }}" method="POST" style="display:inline-block;">
    @csrf
    @method('PUT')
